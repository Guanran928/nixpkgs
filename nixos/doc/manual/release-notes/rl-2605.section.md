...
- [Rustical](https://github.com/lennart-k/rustical), a calendar server aiming to be simple, fast and passwordless. Available as [services.rustical](options.html#opt-services.rustical.enable).
